package ch.hintzy.jhipster.application.config;
...
@Configuration
@EnableJpaRepositories("ch.hintzy.jhipster.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("ch.hintzy.jhipster.application.repository.search")
